...
export default function HomeWatchTemplate({
  WatchCardComponent = WatchCard,
}) {
  const Card = WatchCardComponent
    ...
    <div className="bg-bg overflow-clip relative rounded-[30px] w-[393px] h-[852px] font-['Inter',sans-serif]">
      ...
      <div className="absolute left-[24px] top-[72px] right-[24px] flex items-center">
        <div className="flex items-baseline">
          <p className="font-medium text-[20px] text-text-1 leading-normal">Watch</p>
          <p className="ml-[12px] font-medium text-[16px] text-text-2 leading-normal">Bookings</p>
        </div>
