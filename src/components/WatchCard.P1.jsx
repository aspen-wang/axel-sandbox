...
// P1 — Minimal. Price large white left, strikethrough gray right. Green savings pill below. No button.
...
export default function WatchCardP1({ watch, state, onClick }) {
  return (
    <div className="bg-bg-2 rounded-[16px] overflow-hidden" onClick={onClick}>
      ...
      {/* Price — Minimal: large white price left, strikethrough gray right */}
