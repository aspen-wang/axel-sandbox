...
// Base — matches K5 (edge-to-edge image with chain pill, compact inset row)
...
export default function HotelWatchCard({ watch, onClick }) {
      ...
      <div className="relative h-[100px] bg-[#2A2A2A] flex items-center justify-center">
        ...
        <div className="absolute bottom-[8px] right-[10px] bg-black/70 rounded-[8px] px-[10px] py-[6px]">
          <div className="flex items-baseline">
            <p className="font-semibold text-[16px] text-text-1 leading-[1]">${axelPrice}</p>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-right shrink-0">
            ...
            <div className="flex items-center justify-end mt-[3px]">
              ...
              {saved > 0 && (
                <p className="font-['Lato',sans-serif] font-semibold text-[10px] text-green leading-[1] ml-[6px]">-${saved * watch.nights}</p>
              )}
            </div>
          </div>
        </div>
