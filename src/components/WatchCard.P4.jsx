...
// P4 — Savings-first. Lead with green savings text, prices below smaller.
...
export default function WatchCardP4({ watch, state, onClick }) {
  return (
    <div className="bg-bg-2 rounded-[16px] overflow-hidden" onClick={onClick}>
      ...
      {/* Price — Savings-first: green savings as hero, prices below */}
      <div className="px-[16px] pt-[16px] pb-[16px]">
        <p className="font-['Inter',sans-serif] font-medium text-[16px] text-green leading-[1]">Save $48 (11%)</p>
        <p className="font-['Lato',sans-serif] text-[12px] text-text-2 leading-[1.5] mt-[6px]">
          <span className="text-text-1 font-medium">$372</span> with Axel · <span className="line-through text-text-2/50">$420</span> market
        </p>
      </div>
    </div>
  )
