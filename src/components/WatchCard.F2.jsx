...
// F2 — Boarding Pass + Axel Savings: clean price comparison, airy layout
...
export default function WatchCardF2({ watch, state = 'watching', onClick }) {
  ...
  return (
    <div className="bg-bg-2 rounded-[16px] overflow-hidden" onClick={onClick}>
      ...
      <div className="flex items-center justify-between px-[16px] pt-[14px] pb-[12px]">
        ...
        {/* Price: Axel hero, original struck */}
      ...
      {/* Axel savings strip — separated, breathable */}
