...
// P5 — With CTA. Price left with strikethrough below, outlined View Deal button right. Green savings pill above.
...
export default function WatchCardP5({ watch, state, onClick }) {
  return (
    <div className="bg-bg-2 rounded-[16px] overflow-hidden" onClick={onClick}>
      ...
      {/* Price — With CTA: savings pill, price left, outlined button right */}
      <div className="px-[16px] pt-[16px] pb-[16px]">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="font-['Lato',sans-serif] text-[12px] text-text-2/50 leading-[1.5] line-through">$420</p>
          </div>
          <div className="flex items-center justify-center px-[20px] py-[10px] rounded-[10px] border border-text-1">
            <p className="font-['Inter',sans-serif] font-medium text-[13px] text-text-1 leading-[1]">View Deal</p>
          </div>
        </div>
      </div>
    </div>
