...
// F3-C — Price Dropping · 1 Stop · Visible stop codes
...
function DownArrow() {
  return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-text-2 shrink-0">
      <path d="M12 5v14M19 12l-7 7-7-7" />
    </svg>
  )
}

export default function WatchCardF3C({ watch, state, onClick }) {
  return (
    <div className="bg-bg-2 rounded-[16px] overflow-hidden" onClick={onClick}>
      {/* Status bar — price dropping */}
      <div className="bg-text-2/5 flex items-center px-[16px] py-[12px]">
        ...
        <p className="font-['Lato',sans-serif] text-[12px] text-text-2 leading-[1.5] ml-[8px]">
          Price is dropping! $30 above your target
        </p>
      </div>

      {/* Outbound — 1 stop, all codes visible */}
      ...
      <div className="px-[16px] pt-[16px] pb-[16px]">
        <div className="flex items-baseline justify-between">
          <p className="font-['Inter',sans-serif] font-medium text-[20px] text-text-1 leading-[1]">$395</p>
        ...
        <div className="bg-green/8 rounded-[10px] px-[12px] py-[10px] mt-[12px] flex items-center justify-between">
          <div className="flex items-center">
            ...
            <p className="font-['Lato',sans-serif] text-[12px] text-text-2 leading-[1]">Save $25 (6%)</p>
          </div>
