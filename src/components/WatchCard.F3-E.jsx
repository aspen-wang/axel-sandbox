...
// F3-E — Deal Found · 1 Stop · Visible stop codes + CTA
...
export default function WatchCardF3E({ watch, state, onClick }) {
  return (
    <div className="bg-bg-2 rounded-[16px] overflow-hidden" onClick={onClick}>
      {/* Status bar — deal found / green */}
      ...
      <div className="px-[16px] pt-[16px]">
        <div className="flex items-baseline justify-between">
          <p className="font-['Inter',sans-serif] font-medium text-[20px] text-green leading-[1]">$372</p>
        ...
        <div className="bg-green/8 rounded-[10px] px-[12px] py-[10px] mt-[12px] flex items-center justify-between">
          <div className="flex items-center">
            ...
            <p className="font-['Lato',sans-serif] text-[12px] text-text-2 leading-[1]">Save $48 (11%)</p>
          </div>
      ...
      <div className="px-[16px] pt-[12px] pb-[16px]">
        <div className="flex items-center justify-center w-full py-[12px] bg-green rounded-[12px]">
          <p className="font-['Inter',sans-serif] font-medium text-[14px] text-white leading-[1]">View Deal</p>
        </div>
      </div>
    </div>
  )
