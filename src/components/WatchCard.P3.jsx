...
// P3 — Price card. Price inside elevated container. Axel white left, market strikethrough right, savings badge full width below.
...
export default function WatchCardP3({ watch, state, onClick }) {
  return (
    <div className="bg-bg-2 rounded-[16px] overflow-hidden" onClick={onClick}>
      ...
      {/* Price — Elevated card container */}
      <div className="px-[16px] pt-[16px] pb-[16px]">
        <div className="bg-[#2A2A2A] rounded-[12px] px-[14px] py-[12px]">
          <div className="flex items-baseline justify-between">
          ...
          <div className="mt-[10px] flex items-center justify-center py-[6px] rounded-[8px] bg-green/10">
            <p className="font-['Lato',sans-serif] text-[11px] text-green leading-[1]">Save $48 (11%) vs market</p>
          </div>
        </div>
      </div>
    </div>
