...
// R1 — Compact tear line. Origin → Dest only, "2 stops via DEN, SFO" in subtitle. Tighter spacing.
...
export default function WatchCardR1({ watch, state, onClick }) {
  return (
    <div className="bg-bg-2 rounded-[16px] overflow-hidden" onClick={onClick}>
      ...
      {/* Outbound — origin → dest, stops in subtitle */}
      <div className="px-[16px] pt-[14px]">
        ...
        <p className="font-['Lato',sans-serif] text-[11px] text-text-2 leading-[1.5] mt-[2px]">
          2 stops via DEN, SFO · Mar 5
        </p>
      </div>
